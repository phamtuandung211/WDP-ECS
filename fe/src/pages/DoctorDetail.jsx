...
const DoctorDetailPage = () => {
    ...
    if (!doctor) return <div className="p-20 text-center">Không tìm thấy bác sĩ</div>;
                ...
                <div className="bg-white rounded-3xl shadow-lg p-10 flex flex-col md:flex-row gap-10">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-4 space-y-2 text-gray-600">
                            ...
                            <p><strong>Ngày sinh:</strong> {doctor?.dateOfBirth ? new Date(doctor.dateOfBirth).toLocaleDateString() : "N/A"}</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {doctor.certificates?.map((cer) => (
                            <div key={cer?._id} className="border p-4 rounded-xl shadow-sm">
                                ...
                                <p className="text-gray-500 text-sm">Cấp bởi: {cer?.issuedBy}</p>
                                <p className="text-gray-500 text-sm">
                                    Ngày cấp: {cer?.issueDate ? new Date(cer.issueDate).toLocaleDateString() : "N/A"}
                                </p>
                                <a
                                    href={cer?.fileUrl}
                                    target="_blank"
